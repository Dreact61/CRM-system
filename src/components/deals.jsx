...
import StoreDeals, {allDeals} from "../data/typeDeals";
...
const notCompleted = allDeals.filter(deal => deal.dealStatus === "current")
        ...
        <div className={`${cardStyles} md:w-9/10 w-3/5`}>
          ...
          <div className="flex md:flex-row flex-col">
            <div className={`${cardStyles} ${borderStyles} ${textStyles} md:w-2/5 m-auto w-3/5 border-t gap-2 pt-1 pb-2`}>
                        ...
                        {notCurrent && notCurrent.length !== 0
                        ? notCurrent.map(deal => (
